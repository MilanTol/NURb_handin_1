...
amplitude of the oscillation in the z coordinate of the terrestrial planets increases over time. Hinting 
...
the index of the current node, the boxsize of the current node, depth of the current node, and the desired max depth of the tree.
...
More technically: For each pixel in the mass map, we call the get-node-at-level function.
...
5 and 7, are plotted in Figures \ref{fig2a_level3, fig2a_level5, fig2a_level7}.
