...
from fft import fft3d, fft_frequencies
...
def main() -> None:
    ...
    fill_massmap_from_octree(root, level=level, massmap=massgrid)
    ...
    FTpotential = -G / np.pi * FTdensgrid / k2

    # compute the potential
    potential = fft3d(FTpotential, inverse=True)
