...
print(mars) # a test for you, don't leave it in
...
# calculate the v_x velocity in AU/yr
print(marsvelocity.x.to_value(u.AU / u.yr))


def get_initial_conditions(time:Time, bodies:dict) -> tuple[np.ndarray, np.ndarray]:
    """
    ...
    for body in bodies.keys():
        ...
        with solar_system_ephemeris.set("jpl"):
            body_posvel = get_body_barycentric_posvel(body, t)
